module.exports = (function() {
	...
	function getUsers(req, res, mysql, context, complete) {
		var sql =
			'SELECT user.user_name, song.song_name, artist.artist_name, user.user_id FROM user LEFT JOIN song ON user.sid = song.song_id LEFT JOIN artist ON song.aid = artist.artist_id';
